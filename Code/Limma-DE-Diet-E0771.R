...
new_count <- onlyE0771Count(countData)
new_meta <- onlyE0771Meta(metaData)
...
fit <- eBayes(fit)
topTable(fit)
write.csv(topTable(fit, number = 10000, p.value = .05), file = "LIMMA-E0771.csv")
# 5867 Genes with n adjusted pval < .05